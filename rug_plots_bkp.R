...
rug_plot_selected<-function(dates, pngpath, value, mutations, foreign_mutations){
		...
		p<-ggplot(dates) +  
			...
			#c("200958","204005","202102","202919","207901")
			geom_count(data = melted_cluster_nondelta, aes(x=date, y=entry_sorted), color = "black", alpha = 0.5)+
			geom_count(data = melted_cluster_delta, aes(x=date, y=entry_sorted, color=mutated), alpha = 0.5)+
