...
tree=${variants_folder}/megatest/3clades.nozero.bif.nwk
...
python up_and_cut.py --tree $tree --node 155852 --number 10 --step 1 --output $variants_folder/megatest/testtree
testtree=$variants_folder/megatest/testtree_3_stepup1.nwk
xvfb-run megacc -a $mao -d ${tree}.all.cut.fasta -f Fasta -t $testtree -o ${testtree}.ancestors
testtree=$variants_folder/megatest/testtree_4_stepup1.nwk
xvfb-run megacc -a $mao -d ${tree}.all.cut.fasta -f Fasta -t $testtree -o ${testtree}.ancestors
testtree=$variants_folder/megatest/testtree_5_stepup1.nwk
xvfb-run megacc -a $mao -d ${tree}.all.cut.fasta -f Fasta -t $testtree -o ${testtree}.ancestors
testtree=$variants_folder/megatest/testtree_6_stepup1.nwk
xvfb-run megacc -a $mao -d ${tree}.all.cut.fasta -f Fasta -t $testtree -o ${testtree}.ancestors
testtree=$variants_folder/megatest/testtree_7_stepup1.nwk
xvfb-run megacc -a $mao -d ${tree}.all.cut.fasta -f Fasta -t $testtree -o ${testtree}.ancestors
testtree=$variants_folder/megatest/testtree_8_stepup1.nwk
xvfb-run megacc -a $mao -d ${tree}.all.cut.fasta -f Fasta -t $testtree -o ${testtree}.ancestors
