...
# --entry_dates_file ${translin_file}.dates_stats --pangolined_file $rus_pangolined_from_tree \
...
Rscript rug_plots.R --data_file ${output_folder}/${tag}_data.csv --lineage "BA" \
--melted_entries_file ${output_folder}/melted_entries.withdates.csv --districts ${output_folder}/leaf_districts.csv \
--output_folder $output_folder --tag $tag 
##
